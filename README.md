...
- **Week 2** - Mini game with functions, while loops, conditions and stats tracking
- **Week 3** - Mini calculator with functions, while loops, return values, error handling with try/except
